...
export default function ScoreDisplay({
  ...
  return (
    ...
    >
      ...
      {/* Player Statistics with Tabs */}
      {scoreData.points && scoreData.points.length > 0 && (
        <div
          className={`${theme.border} border rounded-lg p-4 mb-6 relative z-10`}
          style={theme.borderStyle}
        >
                ...
                if (scoreData.points && scoreData.points.length > 0) {
                  scoreData.points.forEach((point) => {
                    if (point.player_id) {
                      ...
                      else if (point.type === "unspecified")
                        stats.unspecified++;
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {player.unspecified > 0 && (
                          <div className="flex items-center space-x-1">
                            ...
                            <span
                              className={`text-sm font-semibold ${theme.text} bg-gray-100 dark:bg-gray-600/30 px-2 py-1 rounded`}
                              style={theme.textStyle}
                            >
                              {player.unspecified}
                            </span>
                        ...
                        {/* Total */}
                        <div
                          className={`text-sm font-bold ${theme.text} bg-gray-200 dark:bg-gray-700 px-3 py-1 rounded border-2 border-gray-300 dark:border-gray-600`}
                          style={theme.textStyle}
                          title="Total Points"
                        >
                          {player.total}
